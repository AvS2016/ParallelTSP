...
namespace tsp
{
    ...
    :graph_(graph), settings_(),rand_(), currPopulation_(new Population()), nextPopulation_(new Population()),
     fitnessUpdater_(graph), selector_(graph), crossover_(), populationGen_(graph), mutator_()
    {
